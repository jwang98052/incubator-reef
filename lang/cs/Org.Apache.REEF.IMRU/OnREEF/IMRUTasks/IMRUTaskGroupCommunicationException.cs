...
{
    /// <summary>
    /// A serialiable exception that represents a task group communication error.
    /// </summary>
    [Serializable]
    internal sealed class IMRUTaskGroupCommunicationException : Exception
    {
        /// <summary>
        /// Constructor. A serialiable exception object that represents a task group communication error.
        /// </summary>
